...
class WilayaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $wilayas = [
            ...
            ["id"=>6,"name"=>"Béjaïa","zone"=>2,"is_deliverable"=>1], // Corrected name
            ["id"=>7,"name"=>"Biskra","zone"=>3,"is_deliverable"=>1],
            ["id"=>8,"name"=>"Béchar","zone"=>4,"is_deliverable"=>1],  // Corrected name
            ...
            ["id"=>12,"name"=>"Tébessa","zone"=>3,"is_deliverable"=>1], // Corrected name
            ...
            ["id"=>19,"name"=>"Sétif","zone"=>2,"is_deliverable"=>1],  // Corrected name
            ["id"=>20,"name"=>"Saïda","zone"=>2,"is_deliverable"=>1], // Corrected name
            ["id"=>21,"name"=>"Skikda","zone"=>2,"is_deliverable"=>1],
            ["id"=>22,"name"=>"Sidi Bel Abbès","zone"=>2,"is_deliverable"=>1], // Corrected name
            ...
            ["id"=>26,"name"=>"Médéa","zone"=>2,"is_deliverable"=>1], // Corrected name
            ...
            ["id"=>35,"name"=>"Boumerdès","zone"=>1,"is_deliverable"=>1],  // Corrected name
            ...
            ["id"=>44,"name"=>"Aïn Defla","zone"=>2,"is_deliverable"=>1], // Corrected name
            ["id"=>45,"name"=>"Naâma","zone"=>4,"is_deliverable"=>1], // Corrected name
            ["id"=>46,"name"=>"Aïn Témouchent","zone"=>2,"is_deliverable"=>1], // Corrected name
            ["id"=>47,"name"=>"Ghardaïa","zone"=>3,"is_deliverable"=>1], // Corrected name
            ...
            ["id"=>52,"name"=>"Béni Abbès","zone"=>4,"is_deliverable"=>1], // Corrected name
